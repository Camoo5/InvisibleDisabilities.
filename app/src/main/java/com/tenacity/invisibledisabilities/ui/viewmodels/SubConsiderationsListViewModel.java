 ...
 */
public class SubConsiderationsListViewModel extends ViewModel {
    ...
    public SubConsiderationsListViewModel(SubConsiderationsRepository subConsiderationsRepository, HiddenDisabilityRepository hiddenDisabilityRepository, String subconsiderationsId) {
        super();
