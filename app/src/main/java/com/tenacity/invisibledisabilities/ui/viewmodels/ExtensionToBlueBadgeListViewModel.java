 ...
 */
public class ExtensionToBlueBadgeListViewModel extends ViewModel {
    ...
    public ExtensionToBlueBadgeListViewModel(ExtensionToBlueBadgeRepository extensionToBlueBadgeRepository, HiddenDisabilityRepository hiddenDisabilityRepository, String extensiontobluebadgeId) {
        super();
