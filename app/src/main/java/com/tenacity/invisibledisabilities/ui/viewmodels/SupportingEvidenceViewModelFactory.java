...
public class SupportingEvidenceViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    ...
    public SupportingEvidenceViewModelFactory(SupportingEvidenceRepository supportingEvidenceRepository, HiddenDisabilityRepository hiddenDisabilityRepository,
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new SupportingEvidenceViewModel (supportingEvidenceRepository, hiddenDisabilityRepository, supportingevidenceId);
    }
}