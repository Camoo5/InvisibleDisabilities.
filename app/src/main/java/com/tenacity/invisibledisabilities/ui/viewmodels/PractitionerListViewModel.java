 ...
 */
public class PractitionerListViewModel extends ViewModel {
    ...
    public PractitionerListViewModel(PractitionerRepository practitionerRepository, HiddenDisabilityRepository hiddenDisabilityRepository, String practitionerId) {
        super();
