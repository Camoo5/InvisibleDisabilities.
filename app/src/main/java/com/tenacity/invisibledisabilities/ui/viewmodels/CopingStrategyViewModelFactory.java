...
public class CopingStrategyViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    ...
    public CopingStrategyViewModelFactory(CopingStrategyRepository copingStrategyRepository, HiddenDisabilityRepository hiddenDisabilityRepository,
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new CopingStrategyViewModel(copingStrategyRepository, hiddenDisabilityRepository, copingstrategyId);
    }
}