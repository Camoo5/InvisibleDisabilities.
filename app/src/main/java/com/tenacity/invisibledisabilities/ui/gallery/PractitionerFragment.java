...
import com.tenacity.invisibledisabilities.ui.viewmodels.PractitionerListViewModel;
...
public class PractitionerFragment extends Fragment {
    ...
    private PractitionerListViewModel viewModel;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentPractitionerBinding binding = FragmentPractitionerBinding .inflate(inflater, container, false);
        PractitionerListViewModelFactory factory = InjectorUtils.providePractitionerViewModelFactory (getContext());
