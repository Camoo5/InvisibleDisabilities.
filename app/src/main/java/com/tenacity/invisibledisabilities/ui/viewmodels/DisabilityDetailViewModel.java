...
public class DisabilityDetailViewModel extends ViewModel {
    ...
    DisabilityDetailViewModel(DisabilityRepository disabilityRepository, HiddenDisabilityRepository hiddenDisabilityRepository, String disabilityId) {
         ...
         * true. */
        LiveData<HiddenDisability> hiddenDisabilityForDisability = hiddenDisabilityRepository.getHiddenDisabilityForDisability(disabilityId);
        this.isDisabled= Transformations.map(hiddenDisabilityForDisability, it -> it != null);
